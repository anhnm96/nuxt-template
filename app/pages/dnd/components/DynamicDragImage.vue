<script>
import VDragDrop from '~/components/base/dnd/DragItem.vue'
...
<template>
  <div>
    ...
    <VDragDrop
      ...
      @dragend="dragend"
    >
      <img :draggable="false" class="document" src="~/assets/img/drag/document.png">
      <template #drag-image>
        <img v-show="idx === 0" class="drag-image" src="~/assets/img/drag/smiley01.png">
        <img v-show="idx === 1" class="drag-image" src="~/assets/img/drag/smiley02.png">
        <img v-show="idx === 2" class="drag-image" src="~/assets/img/drag/smiley03.png">
        <img v-show="idx === 3" class="drag-image" src="~/assets/img/drag/smiley04.png">
        <img v-show="idx === 4" class="drag-image" src="~/assets/img/drag/smiley05.png">
        <img v-show="idx === 5" class="drag-image" src="~/assets/img/drag/smiley06.png">
      </template>
    </VDragDrop>
  </div>
</template>
...
<style scoped>
.trash {
  background-image: url('~/assets/img/drag/trash.png');
