...
import harrietArron from '~/assets/testimonials/harriet-arron.jpg'
import tinyYards from '~/assets/testimonials/tina-yards.jpg'
import veronicaWinton from '~/assets/testimonials/veronica-winton.jpg'
